...
function ToAvi() {
  ...
  const handleUpload = async (file) => {
    ...
    try {
      ...
      const res = await fetch(`${API}/to-avi`, {
        method: 'POST',
        body: fd,
      })
        ...
        {!uploaded ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Convert videos into AVI format instantly
            </p>
              ...
              className={`
                ...
                ${
                  dragActive
                    ...
                    : 'border-slate-700 bg-slate-900 hover:border-green-400 hover:bg-slate-800'
                }
              `}
            >
              ...
              <div className="p-14 flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 text-sm mt-3 text-center">
                  Fast AVI conversion with high quality
                </p>
