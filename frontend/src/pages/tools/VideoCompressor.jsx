...
import videoCompressorIcon from '../../assets/compress-image.png'
        ...
        {!uploaded ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Compress videos while keeping high quality
            </p>
              ...
              className={`
                ...
                ${
                  dragActive
                    ...
                    : 'border-slate-700 bg-slate-900 hover:border-red-400 hover:bg-slate-800'
                }
              `}
            >
              ...
              <div className="p-14 flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 text-sm mt-3 text-center">
                  Fast video compression with high quality
                </p>
