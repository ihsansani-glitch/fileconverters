...
function HeicToJpg() {
  ...
  const handleUpload = async (file) => {
    ...
    try {
      ...
      const res = await fetch(`${API}/heic-to-jpg`, {
        method: 'POST',
        body: fd,
      })
        ...
        {!uploaded ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Convert HEIC images into JPG format instantly and easily
            </p>
            ...
            >
              ...
              <div className="p-14 flex flex-col items-center justify-center">
                ...
                <p className="text-slate-400 text-lg mt-4 text-center">
                  Drag & drop HEIC image here or click to browse
                </p>

                <p className="text-slate-500 text-sm mt-3 text-center">
                  Fast high-quality JPG conversion
                </p>
