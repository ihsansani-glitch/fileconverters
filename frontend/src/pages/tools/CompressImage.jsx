        ...
        {!uploaded ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Reduce image size while maintaining high quality instantly
            </p>
              ...
              className={`
                ...
                ${
                  dragActive
                    ...
                    : 'border-slate-700 bg-slate-900 hover:border-orange-400 hover:bg-slate-800'
                }
              `}
            >
