        ...
        {!uploaded ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Convert SVG vector files into high-quality PNG instantly
            </p>
              ...
              className={`
                ...
                ${
                  dragActive
                    ...
                    : 'border-slate-700 bg-slate-900 hover:border-fuchsia-400 hover:bg-slate-800'
                }
              `}
            >
              ...
              <div className="p-14 flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 text-sm mt-3 text-center">
                  Fast high-quality PNG conversion
                </p>
              ...
              >
                ...
                {loading ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-fuchsia-400 text-xl font-semibold">
                      Converting Image...
                    </p>
