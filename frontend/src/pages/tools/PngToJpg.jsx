        ...
        {!downloadUrl ? (
          ...
          <div className="flex flex-col items-center justify-start pt-6">
            ...
            <p className="text-slate-400 mt-4 text-center">
              Convert PNG images into high-quality JPG instantly
            </p>
            ...
            {loading && (
              ...
              <p className="text-purple-400 mt-6 text-lg font-medium">
                Converting Image...
              </p>
          ...
          <div className="max-w-6xl mx-auto w-full pb-24 px-4">
            ...
            >
              ...
              <p className="text-slate-400 mt-4 text-center max-w-xl">
                Your PNG image was converted into JPG format successfully.
              </p>
